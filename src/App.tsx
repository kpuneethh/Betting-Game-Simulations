    ...
    <div className="App">
      <header className="App-header">
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          Suppose you have $5 and your goal is to reach $25 in earnings cumulatively by betting your money. Each bet you place has a 67% chance of losing and 33% chance of winning. That means, if you’re starting with $5 and bet $3, you have a 33% chance of winning $3 to have a new balance of $8, and a 67% chance of losing $3 to have a new balance of $2. For every turn, the minimum bet you can place is $1 and the maximum bet you can place is your current balance. If your balance reaches $0 and you haven’t reached the cumulative goal of $25 yet, you fail.
          </p>
          <p>
